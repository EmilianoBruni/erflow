...
import {
    createDefaultCard,
    exportCardsToJson,
    importCardsFromJson as parseCardsFromJson,
    importCardsFromClipboard as parseCardsFromClipboard
} from '@/lib/card-import-export';
...
export default function Page() {
    ...
    function importCardsFromJson(text: string) {
        const restored = parseCardsFromJson(text);
        if (restored) {
            setCards(restored);
        }
    }
